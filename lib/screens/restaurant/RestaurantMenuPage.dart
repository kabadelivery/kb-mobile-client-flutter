...
import 'package:kaba_flutter/utils/customwidgets/RestaurantFoodListWidget.dart';
...
class _RestaurantMenuPageState extends State<RestaurantMenuPage> {
  ...
  Widget build(BuildContext context) {
    ...
    /* return Scaffold(
        ...
        drawer: _myNavigationDrawer,
        floatingActionButton:
//            Transform.rotate(angle: null, c
        RotatedBox(child: FlatButton.icon(onPressed: (){_scaffoldKey.currentState.openDrawer();},
