...
class ServerRoutes {
  ...
  /* get current basket content */
  static const String LINK_MY_BASKET_CREATE =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/basket/create";

  /* get current horoscope content */
  static const String LINK_MY_HOROSCOPE =
      ServerConfig.SERVER_ADDRESS + "/sample/horoscope.json";

  /* get current favorite content */
  static const String LINK_MY_FAVORITE =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/getFavorites";

  /* set favorite */
  static const String LINK_SET_FAVORITE =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/setFavorite";

  /* get current adresses content */
  static const String LINK_GET_ADRESSES =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/getAdresses";

  /* create new adresses content */
  static const String LINK_CREATE_NEW_ADRESS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/createV2Adresses";
  ...
  /* delete address */
  static const String LINK_DELETE_ADRESS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/deleteV2Adresses";

  /* accept incoming address */
  static const String LINK_ACCEPT_INCOMING_ADDRESS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/address/accept";

  /* refuse incoming address */
  static const String LINK_REFUSE_INCOMING_ADDRESS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/address/refuse";

  /* toggle receiving incoming address */
  static const String LINK_TOGGLE_ACCEPT_INCOMING_ADDRESS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/receive_address/toggle";

  /* get current account informations */
  static const String LINK_MY_ACCOUNT_INFO =
      ServerConfig.SERVER_ADDRESS + "/sample/useraccount.json";

  /* menu food*/
  static const String LINK_MENU_BY_RESTAURANT_ID =
      ServerConfig.SERVER_ADDRESS + "/api/menu/get";

  static const String LINK_MENU_BY_ID =
      ServerConfig.SERVER_ADDRESS + "/api/menu/get/id";

  static const String LINK_RESTO_LIST =
      ServerConfig.SERVER_ADDRESS + "/api/restaurant/get";

  static const String LINK_RESTO_LIST_V2 =
  ...
  static const String LINK_USER_LOGIN_V3 =
      ServerConfig.SERVER_ADDRESS_SECURE + "/api/user/otp-login";

  /* user register */
  static const String LINK_USER_REGISTER =
      ServerConfig.SERVER_ADDRESS_SECURE + "/api/user/register";

  /* register push token */
  static const String LINK_REGISTER_PUSH_TOKEN =
...
//  static const String LINK_PHONE_UPDATE_SERVER_PUSH_TOKEN = ServerConfig.SERVER_ADDRESS+"/mobile/api/update_client_push_token";
  ...
  static const String LINK_NOTIFICATION_FOOD_DATA =
      ServerConfig.SERVER_ADDRESS + "/notification/food";

  /* get notification menu data */
  static const String LINK_NOTIFICATION_RESTAURANT_DATA =
      ServerConfig.SERVER_ADDRESS + "/notification/restaurant";

  /* get notification menu data */
  static const String LINK_NOTIFICATION_MENU_DATA =
      ServerConfig.SERVER_ADDRESS + "/notification/menu";

  /* delete basket item */
  static const String LINK_MY_BASKET_DELETE =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/basket/delete";

  // /* update user informations */api/code/check
  static const String LINK_UPDATE_USER_INFORMATIONS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/change";

  /* get article informations */
  static const String LINK_ARTICLE_INFORMATIONS =
      ServerConfig.SERVER_ADDRESS + "/api/article/get";

  /* get position details */
  static const String LINK_GET_LOCATION_DETAILS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/district/get";
  ...
  static String LINK_GET_CUSTOMER_SERVICE_ALL_MESSAGES =
  ...
  static const String LINK_GET_FOOD_DETAILS_SIMPLE =
      ServerConfig.SERVER_ADDRESS + "/api/food/details/get";

  static const String LINK_SEARCH_FOOD_BY_TAG =
      ServerConfig.SERVER_ADDRESS + "/api/food/search";

  static const String LINK_GET_EVENEMENTS_LIST =
      ServerConfig.SERVER_ADDRESS + "/api/event/get";

  static const String LINK_CHECK_VERIFCATION_CODE =
      ServerConfig.SERVER_ADDRESS + "/api/code/check";

  static const String LINK_CHECK_RECOVER_VERIFCATION_CODE =
      ServerConfig.SERVER_ADDRESS + "/api/password/code/check";

  static const String LINK_GET_RESTAURANT_REVIEWS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/comment/get";

  /* Review - */
  static const String LINK_POST_COMMENT =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/comment/add";

  static const String LINK_GET_RESTAURANT_DETAILS =
      ServerConfig.SERVER_ADDRESS + "/api/find/restaurant";

  static const String LINK_TRY_LOGOUT =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/logout_client_device";

  static const String LINK_CHECK_CAN_COMMENT =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/canComment";

  /* pay addresses */
  static const String LINK_GET_TRANSACTION_HISTORY =
      ServerConfig.PAY_SERVER_ADDRESS_SECURE +
          "/mobile/api/user/transaction/history";

  static const String LINK_GET_POINT_TRANSACTION_HISTORY =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/kaba/point/get/v2";

  static const String LINK_GET_BALANCE =
      ServerConfig.PAY_SERVER_ADDRESS_SECURE +
          "/mobile/api/user/transaction/balance/get";

  static const String GET_KABA_POINTS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/kaba/point/get";
...
//  static const String LINK_GET_MY_VOUCHERS = ServerConfig.SERVER_ADDRESS+"/mobile/api/voucher/all";
  ...
  /* flooz top up */
  static const String LINK_TOPUP_FLOOZ =
      ServerConfig.PAY_SERVER_ADDRESS_SECURE + "/mobile/api/sms/payment/init";

  /* t-money top up */
  static const String LINK_TOPUP_TMONEY =
      ServerConfig.PAY_SERVER_ADDRESS_SECURE + "/mobile/api/web/payment/init";

  static const String LINK_TOPUP_PAYDUNYA =
      ServerConfig.PAY_SERVER_ADDRESS_SECURE +
          "/mobile/api/bankcard/payment/init";

  /* reset password */
  static const String LINK_PASSWORD_RESET =
      ServerConfig.SERVER_ADDRESS_SECURE + "/api/password/reset";
...
//  static const String common_server_address = "";
  ...
  static const String LINK_GET_SPONSORSHIP_CODE =
      ServerConfig.SERVER_ADDRESS_SECURE +
          "/mobile/api/user/sponsorshipcode/get";

  /* get sponsored */
  static const String LINK_GET_SPONSORED =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/sponsor";

  /* get sponsorship stats */
  static const String LINK_GET_LAST_SPONSORSHIP_FEEDS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/last/sponsorship/get";

  static const String LINK_GET_ALL_SPONSORSHIP_HISTORY =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/user/all/sponsorship/get";
  ...
  static const String LINK_CHECK_UNREAD_MESSAGES =
      ServerConfig.SERVER_ADDRESS_SECURE + "/mobile/api/user/new/message/check";

  static const String LINK_GET_MY_VOUCHERS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/vouchers/get";

  static const String LINK_GET_VOUCHERS_FOR_ORDER =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/vouchers/valid/get";

  static const String LINK_SUBSCRIBE_VOUCHERS =
      ServerConfig.SERVER_ADDRESS + "/mobile/api/vouchers/subscribe";
  ...
  static String LINK_GET_SERVICE_CATEGORIES =
      ServerConfig.SERVER_ADDRESS + "/api/services/categories";
  ...
  static const String LINK_GET_SKIP_NOTATION_STATUS = ServerConfig.STAT_SERVER_ADDRESS + "/mobile/api/notation-skip/status/get";
}
