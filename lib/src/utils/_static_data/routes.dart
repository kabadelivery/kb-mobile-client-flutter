...
//  QrCodeScannerPage.routeName : (BuildContext context) => QrCodeScannerPage(),
  ...
  // OrderDetailsPage.routeName : (BuildContext context) => OrderDetailsPage(presenter: OrderDetailsPresenter(OrderDetailsView())),
  // TopUpPage.routeName : (BuildContext context) => TopUpPage(presenter: TopUpPresenter(TopUpView())),
  SettingsPage.routeName : (BuildContext context) => SettingsPage(),
