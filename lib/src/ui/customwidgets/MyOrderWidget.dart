              ...
              widget?.command?.is_preorder == 1
                  ? Container(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            Text(
                                "${AppLocalizations.of(context)!.translate('delivery_day')}",
                                style: TextStyle(
                                    color: Colors.white, fontSize: 16)),
                            SizedBox(width: 5),
                            Text(
                                "${Utils.timeStampToDayDate(widget.command!.preorder_hour!.start!, dayz: dayz)}",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 18,
              ...
              widget?.command?.is_preorder == 1
                  ? Container(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            Text(
                                "${AppLocalizations.of(context)!.translate('delivery_time_frame')}",
                                style: TextStyle(
                                    color: Colors.white, fontSize: 16)),
                            SizedBox(width: 5),
                            Text(
                                "${Utils.timeStampToHourMinute(widget.command!.preorder_hour!.start!)} à ${Utils.timeStampToHourMinute(widget.command!.preorder_hour!.end!)}",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 18,
                                    fontWeight: FontWeight.bold))
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: CachedNetworkImageProvider(
                                                Utils.inflateLink(command
                                                    .restaurant_entity!
                                                    .pic!))))),
                                SizedBox(width: 10),
                                Text(
                                    "${_reducedRestaurantName(command.restaurant_entity!.name!)}",
                                    style: TextStyle(
...
//                            border: new Border.all(color: Colors.white.withAlpha(100)),
                                  ...
                                  child: Text(_getStateLabel(command),
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                            ...
                            ..addAll(<Widget>[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    "${AppLocalizations.of(context)!.translate('shipping_price')}"
                                        .toUpperCase(),
                                    style: TextStyle(
                                  ...
                                  Container(
                                      ...
                                      child: Text(
                                          "${command?.is_preorder == 1 ? command.preorder_shipping_pricing : (command.is_promotion == 1 ? command.promotion_shipping_pricing : command.shipping_pricing)} F",
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: Colors.white,
                                              fontSize: 16)))
                                ...
                                children: <Widget>[
                                  widget?.command?.voucher_entity != null
                                      ? ClipPath(
                                          ...
                                          child: Container(
                                              ...
                                              child: Center(
                                                  child: Text(
                                                      "- ${widget?.command?.voucher_entity?.value}${widget?.command?.voucher_entity?.category == 1 ? "%" : "F"}",
                                                      style: TextStyle(
                                                          color: priceColor,
                                  ...
                                  Container(
                                      ...
                                      padding: EdgeInsets.only(
                                          top: 5, bottom: 5, right: 5, left: 5),
                                      child: Text(
                                          "${command.shipping_address!.quartier!}",
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                              color: Colors.white,
                                              fontSize: 16))),
                                ...
                                child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(children: <Widget>[
                                        ...
                                        Container(
                                            child: Text(
                                                "${command?.is_preorder == 1 ? command.preorder_total_pricing : (command.is_promotion == 1 ? command.promotion_total_pricing : command.total_pricing)} F",
                                                style: TextStyle(
                                                    fontSize: 16,
                                                    color: Colors.white)),
                                            color: KColors.primaryColor,
