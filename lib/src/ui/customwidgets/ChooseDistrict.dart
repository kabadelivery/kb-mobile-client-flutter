          ...
          onChanged: (value)async  {
            ...
            if(outofAppState.order_type==5){
              ...
              locationNotifier.setShippingAddressPicked(true);
                ...
                locationNotifier.pickOrderAddress(
                    DeliveryAddressModel(
                      id: districtState.selectedDistrict["id"],
                      name: districtState.selectedDistrict["name"],
                      description: districtState.selectedDistrict["description"],
                    )
              );
                formData.add(
