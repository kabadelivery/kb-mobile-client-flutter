              ...
              child: Row(
                children: <Widget>[
                  Flexible(
                    child: RichText(
                        text: TextSpan(
                            text: comment!.name_of_client!.trim(),
                            style: TextStyle(
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Row(
                  children: <Widget>[]..addAll(List<Widget>.generate(
                            comment!.stars!.toInt(), (int index) {
                      return Row(
                        children: [
                          Icon(FontAwesomeIcons.solidStar,
                              color: KColors.primaryYellowColor, size: 14),
                          SizedBox(width: 2),
                        ],
                      );
                    })
              ...
              Row(
                ...
                children: <Widget>[
                  Text("${Utils.readTimestamp(context, comment!.created_at!)}",
