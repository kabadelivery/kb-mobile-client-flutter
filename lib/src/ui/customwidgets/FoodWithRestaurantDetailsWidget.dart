              ...
              Column(children: <Widget>[
                ListTile(
                    ...
                    title:Column(
                      ...
                      children: <Widget>[
                        Text("${widget?.food?.name.toUpperCase()}", overflow: TextOverflow.ellipsis,maxLines: 3, textAlign: TextAlign.left, style: TextStyle(color:Colors.black, fontSize: 14, fontWeight: FontWeight.w500)),
                        SizedBox(height: 5),
                        Row(
                          children: <Widget>[
                            Row(children: <Widget>[
                              Text("${widget?.food?.price}", overflow: TextOverflow.ellipsis,maxLines: 1, textAlign: TextAlign.center, style: TextStyle(color:KColors.primaryYellowColor, fontSize: 20, fontWeight: FontWeight.normal)),

                              (widget?.food.promotion!=0 ? Text("${widget?.food?.promotion_price}",  overflow: TextOverflow.ellipsis,maxLines: 1, textAlign: TextAlign.center, style: TextStyle(color:KColors.primaryColor, fontSize: 20, fontWeight: FontWeight.normal, decoration: TextDecoration.lineThrough))
                                  : Container()),
                    ...
                    Column(children: <Widget>[
                      ListTile(
                          ...
                          leading: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: new DecorationImage(
                                      fit: BoxFit.cover,
                                      image: CachedNetworkImageProvider(Utils.inflateLink(widget?.food?.restaurant_entity?.pic))
                                  )
                              )
                          ),
                          ...
                          title:Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("${widget?.food?.restaurant_entity?.name}", overflow: TextOverflow.ellipsis,maxLines: 2, textAlign: TextAlign.left, style: TextStyle(color:KColors.primaryColor, fontSize: 16, fontWeight: FontWeight.w500)),
                              SizedBox(height:10),
                              Text("${widget?.food?.restaurant_entity?.address}", maxLines:3, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: TextStyle(fontSize: 13, color: Colors.black.withAlpha(150))),
                            ],
                          )
                      ),
                      Container(
                      ...
                      Container(
                          ...
                          child:Row(
                            ...
                            children: <Widget>[
                              Row(children:[
                                _getRestaurantStateTag(widget?.food?.restaurant_entity),
                                SizedBox(width: 5),
                                widget?.food?.restaurant_entity?.coming_soon == 1 ?
                                Container(
                                    padding: EdgeInsets.all(5),
                              ...
                              Row(children: <Widget>[
                                widget?.food?.restaurant_entity?.distance == null ? Container() : Container(
                                    padding: EdgeInsets.all(5),
                                ...
                                SizedBox(width: 10),
                                widget?.food?.restaurant_entity?.distance == null ? Container() : Text("${widget?.food?.restaurant_entity?.distance}${AppLocalizations.of(context).translate('km')}", style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontStyle: FontStyle.normal, fontSize: 12))
                              ])
                            ],
                          ))
                    ])
