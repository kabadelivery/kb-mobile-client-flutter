...
class _PharmacyPageState extends ConsumerState<PharmacyPage> {
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      "https://media.www.kent.ac.uk/nova/programmes/ebf0ba0094c6847b0fd7516f6320db4b8e6c98ca/image_1920w.webp", // use the https link of image0
...
class _FeatureButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFFBE9ED),
        border: Border.all(color: Color(0xFFFFB1C3)),
        borderRadius: BorderRadius.circular(12),
      ),
      child: Row(
        children: [
          Container(
              ...
              child: Icon(icon, color: KColors.primaryColor)),
          const SizedBox(width: 12),
          Expanded(
            child: Text(
              text,
