        ...
        child: Column(
          children: [
                  ...
                  Row(
                    children: [
                      IconButton(
                        ...
                        icon: const Icon(Icons.arrow_back_sharp, color: Colors.white, size: 19),
                      ),
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.translate('out_of_app_title'),
                  ...
                  Row(
                    children: [
                      IconButton(
                        onPressed: () {
                          showBottomContactSheet(
                            context: context,
                            number: '+228${AppConfig.CUSTOMER_CARE_PHONE_NUMBER}',
                          );
                        },
                      ...
                      IconButton(
                        onPressed: () {
                          contactWhatsApp(
                            phoneNumber: "${AppConfig.CUSTOMER_CARE_PHONE_NUMBER}",
                            message: "${AppLocalizations.of(context)!.translate('i_have_an_inquiry')}",
                          );
                        },
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: const LinearGradient(
                              colors: [Color(0xFFD02245), Color(0xFFE43746)],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
                          ),
                          child: const Icon(FontAwesomeIcons.store, color: Colors.white),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisSize: MainAxisSize.min, // prevents it from taking all available space
                            children: [
                              Flexible(
                                child: Text(
                                  AppLocalizations.of(context)!.translate('out_of_app_service_title'),
                              ...
                              Flexible(
                                child: Text(
                                  AppLocalizations.of(context)!.translate('out_of_app_service_subtitle'),
                                  style: const TextStyle(
                                      color: KColors.primaryColor,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 13),
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 2, // optional, allow wrapping
                                ),
                              ),
                            ],
                          ),
                    ...
                    Text(
                      AppLocalizations.of(context)!.translate('out_of_app_service_description'),
                    ...
                    Column(
                      children: [
                        _FeatureButton(
                          ...
                          text: AppLocalizations.of(context)!.translate('feature_secure_service'),
                        ),
                        const SizedBox(height: 10),
                        _FeatureButton(
                          icon: Icons.local_shipping_outlined,
                          text: AppLocalizations.of(context)!.translate('feature_fast_delivery'),
                        ),
                      ],
                    ),
                    const SizedBox(height: 16),
                      ...
                      child: Container(
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(
                            colors: [Color(0xFFCB1F44), Color(0xFFE83C61)],
                            begin: Alignment.topLeft,
                            end: Alignment.bottomRight,
                          ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!.translate('buy_product_button'),
                              style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white),
                            ),
                          ],
                        ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.info_outline, color: KColors.primaryColor),
                  const SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      AppLocalizations.of(context)!.translate('out_of_app_info'),
