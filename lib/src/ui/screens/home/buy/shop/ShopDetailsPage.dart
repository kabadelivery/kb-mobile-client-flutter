...
class ShopDetailsPage extends StatefulWidget {
  ...
  ShopDetailsPage({this.restaurant, this.restaurantId, this.presenter}) {
...
class _ShopDetailsPageState extends State<ShopDetailsPage> implements RestaurantDetailsView {
