...
class _Kaba_abonnementState extends State<Kaba_abonnement> {
  ...
  Future<void> _fetchSubscription() async {
    ...
    final url = Uri.parse("https://0c137bece99a.ngrok-free.app/dashboard/subscribeduser/$customerId");
...
SizedBox(  height: 5),
  ...
  child: ElevatedButton.icon(
    ...
    onPressed: () {
     ...
     _copyToClipboard(context, data["codeAbonnement"]); // <-- ta fonction ici
    },
...
SizedBox(
  ...
  child: ElevatedButton.icon(
    ...
    onPressed: () {
      _shareText(data["codeAbonnement"]); // <-- appelle la fonction partager
    },
  ...
  child: ElevatedButton.icon(
    ...
    label:  Text("Code :"+data["codeAbonnement"]+" • Places restantes : 2"),
  ),
),
  ...
  Widget _buildCardRow({
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Color(0xFFF3F3F5), borderRadius: BorderRadius.circular(8)),
        child: Row(
          children: [
            Container(
              width: 40,
              height: 40,
              decoration: BoxDecoration(color: iconBgColor ?? Colors.grey, borderRadius: BorderRadius.circular(8)),
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: isSvg
                    ? SvgPicture.asset("assets/images/png/abonnement-icons/$icon", fit: BoxFit.contain, color: iconColor)
                    : isIcon
                        ? Icon(Icons.code, color: iconColor)
                        : Image.asset("assets/images/png/abonnement-icons/$icon", fit: BoxFit.contain),
              ),
            ),
            SizedBox(width: 15),
            Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(subtitle, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Colors.black)),
              ],
            )
          ],
        ),
        ...
        child: AppBar(
          ...
          title: Column(
            ...
            children: [
              SizedBox(height: 25),
              Text(
                Utils.capitalize("${AppLocalizations.of(context)?.translate('T_suscription')}"),
                style: TextStyle(color: Colors.white, fontSize: 15),
              ),
              Text("Choisissez la formule qui vous convient", style: TextStyle(fontSize: 12, color: Colors.white70)),
            ],
          ),
        ),
      ),
