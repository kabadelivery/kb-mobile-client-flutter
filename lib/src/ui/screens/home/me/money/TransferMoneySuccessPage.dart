...
class TransferMoneySuccessPage extends StatefulWidget {
  ...
  TransferMoneySuccessPage({Key? key, this.amount, this.moneyReceiver})
      : super(key: key);
  ...
  @override
  _TransferMoneySuccessPageState createState() =>
      _TransferMoneySuccessPageState();
}
...
//                      border: new Border.all(color: Colors.white, width: 2),
                        ...
                        image: new DecorationImage(
                          ...
                          image: new AssetImage(
                              ImageAssets.ic_transaction_success),
                        ))),
                Container(
                    child: Text(
                ...
                Container(
                    child: Text(
                        "${AppLocalizations.of(context)!.translate('payee')}",
                        textAlign: TextAlign.center,
                            ...
                            image: new DecorationImage(
                                ...
                                image: CachedNetworkImageProvider(
                                    Utils.inflateLink(widget
                                        .moneyReceiver!.profile_picture!))))),
                    SizedBox(height: 10),
                    Text(
                      "${widget?.moneyReceiver?.username}",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 17,
                      ...
                      child: OutlinedButton(
                        style: ButtonStyle(
                            side: MaterialStateProperty.all(BorderSide(
                                color: KColors.primaryYellowColor, width: 1))),
                        child: new Text(
                            "${AppLocalizations.of(context)!.translate('ok')}",
                            style:
                                TextStyle(color: KColors.primaryYellowColor)),
                        onPressed: () {
