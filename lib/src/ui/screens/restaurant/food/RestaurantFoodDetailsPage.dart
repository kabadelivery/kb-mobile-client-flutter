...
class RestaurantFoodDetailsPage extends StatefulWidget {
  ...
  RestaurantFoodDetailsPage({Key? key, this.food, this.foodId, this.presenter})
      : super(key: key) {
    this.restaurant = food?.restaurant_entity;
  }

  @override
  _RestaurantFoodDetailsPageState createState() =>
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Row(children: <Widget>[
                                        Text(
                                            "${widget.food!.promotion == 0 ? widget.food?.price : widget.food?.promotion_price}",
                                            style: TextStyle(
                                                fontSize: 30,
                                                color: KColors
                                                    .primaryYellowColor)),
            ...
            child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    IconButton(
                        icon:
                            Icon(Icons.remove_circle, color: KColors.new_black),
                        onPressed: () => _decreaseQuantity()),
                    SizedBox(width: 10),
                    Text("${quantity}",
                        style:
                            TextStyle(color: KColors.new_black, fontSize: 18)),
                    SizedBox(width: 10),
                    IconButton(
                        icon: Icon(Icons.add_circle, color: KColors.new_black),
